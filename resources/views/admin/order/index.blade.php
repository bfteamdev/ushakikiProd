                                        ...
                                        @foreach ($order as $item)
                                            <tr data-row="0" class="datatable-row datatable-row-even">
                                                ...
                                                <td data-field="LastName" aria-label="Pee" class="datatable-cell"><span
                                                        style="width: 137px;">{{ $item->annonce->title }}</span></td>
                                                <td data-field="LastName" aria-label="Pee" class="datatable-cell"><span
                                                        style="width: 137px;">{{ $item->user->firstName }}
                                                        {{ $item->user->lastName }}</span></td>
                                                @if ($item->annonce->category_id != null)

                ...
                <div class="mb">
                    ...
                    <div class="mb-4 row">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="Nom du groupe " name="name" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="form-group col-lg-12 ">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control col-lg-10 @error('icon') is-invalid @enderror"
                                    placeholder="Nom du groupe " name="icon" value="{{ old('icon') }}">
                                @error('icon')
                    ...
                    <div class="form-group col-lg-12 ">
                        ...
                        <input type="number" class="form-control @error('price') is-invalid @enderror"
                            placeholder="Prix du categorie " name="price" value="{{ old('price') }}" min="1">
                        @error('price')

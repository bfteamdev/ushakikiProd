...
@section('content')
    ...
    <div class="card card-custom">
        ...
        {{-- @section("titre") Resultat de votre recherche @endsection   --}}
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane fade show active" id="kt_tab_pane_1_4" role="tabpanel"
                    aria-labelledby="kt_tab_pane_1_4">
                    <form method="GET" action="{{ route('ads.voiture.search') }}">
                        {{-- @method('get') --}}
                                    ...
                                    <tbody class="datatable-body" style="">
                                        @foreach ($searchVoiture as $item)
                                            <tr data-row="0" class="datatable-row datatable-row-even">
                                                ...
                                                <td data-field="Email" aria-label="tpee0@slashdot.org"
                                                    class="datatable-cell"><span
                                                        style="width: 137px;">{{ $item->expired_at }}</span></td>
                                                ...
                                                @endif
                                                <td data-field="action" aria-label="4" class="datatable-cell"><span
                                                        style="width: 137px;"><a
                                                            href="{{ route('ads.voiture.show', ['id' => $item->id]) }}"><span

                            ...
                            <table class="datatable-table" style="display: block;">
                                <thead class="datatable-head">
                                    <tr class="datatable-row">
                                        ...
                                        <th data-field="action" class="datatable-cell datatable-cell-sort"><span style="width: 137px;">Action</span></th>
                                    </tr>
                                </thead>
                                <tbody class="datatable-body" style="">
                                    ...
                                    <tr data-row="0" class="datatable-row datatable-row-even">
                                       ...
                                       @endif
                                        <td data-field="Status" aria-label="4" class="datatable-cell"><span
                                                style="width: 137px;"><a href="{{ route('ads.voiture.show',['id'=>$item->id]) }}"><span

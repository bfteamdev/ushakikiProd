        ...
        <div class="card-body">
            <div class="tab-content">
                <div class="tab-pane fade show active" id="kt_tab_pane_1_4" role="tabpanel"
                    ...
                    <form method="GET" action="{{ route('ads.immobilier.search') }}">
                        {{-- @method('get') --}}
                        <div class="row align-items-center col-lg-12 border-1">
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="input-icon">
                                    <button class="btn btn-success col-lg-12" type="submit">Search</button>
                                </div>
                            </div>
                        </div>
                    </form>
                                        ...
                                        @foreach ($annonce as $item)
                                            <tr data-row="0" class="datatable-row datatable-row-even">
                                                ...
                                                <td data-field="action" aria-label="4" class="datatable-cell"><span
                                                        style="width: 137px;"><a
                                                            href="{{ route('ads.immobilier.show', ['id' => $item->id]) }}"><span

...
@section('style')
    ...
    <div class="card card-custom col-lg-10 mx-auto  example example-compact">
        ...
        @endif
        <form action="{{ route("ads.service.update",["id"=>$service->id]) }}" method="post">
            @csrf
            @method('patch')
                            ...
                            <select name="user_id" class="form-control select2 @error('user_id')
                                ...
                                @foreach ($user as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $item->id === $service->user_id ? 'selected' : '' }}>
                                        {{ $item->username }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-6">
                            ...
                            <input type="date" name="created_at"
                                ...
                                value="{{ $service->created_at->format('Y-m-d') }}" disabled>
                            @error('created_at')
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="date" name="expired_at"
                                ...
                                value="{{ $service->expired_at->format('Y-m-d') }}" disabled>
                            @error('expired_at')
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" name="description"
                                id="kt_autosize_1" rows="3">{{ $service->description }}</textarea>
                        </div>
                    </div>
                                ...
                                <span class="switch switch-outline switch-icon switch-success">
                                    <label>
                                        ...
                                        <input type="checkbox" name="statu" value="active"
                                            {{ $service->statu === 'active' ? 'checked' : '' }} class="disables">
                                        <span></span>
                                    </label>
                                </span>
                            </div>
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="{{ route('ads.service') }}" class="btn btn-dark font-weight-bold mr-2">Back</a>
                    </div>
                </div>
            </div>
        </form>

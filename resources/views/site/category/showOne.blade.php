...
@section('content')
    ...
    <div class="popupChat col-lg-3 col-md-6 col-sm-9">
        <div class="message">
            ...
            <div class="message-footer">
                <div class="message-input">
                    <textarea id="my-textarea" name="" placeholder="Votre message ....."></textarea>
                </div>
                <button class="message-send" type="button">Send <i class="fas fa-paper-plane"></i></button>
            </div>
        </div>
    </div>
@endsection
@section('script')
    ...
    <script src="{{ asset("app-asstets/js/popup.js") }}"></script>
@endsection

                                ...
                                <div role="tabpanel" class="tab-pane fade in active show" id="home"
                                    ...
                                    <div id="container">
                                        ...
                                        <ul class="list">
                                            ...
                                            <a href="{{ route('category.product.one',['name'=> $cat->name  ,'id'=>$item->id]) }}">
                                                <li>
                                                    <img src="{{ asset('storage/'.$image->name) }}" title="" alt="" />
                                            ...
                                            <a href="{{ route('category.product.one',['name'=> $items->name  ,'id'=>$item->id]) }}">
                                                <li>
                                                    <img src="{{ asset('storage/'.$image->name) }}" title="" alt="" />
                                                    <section class="list-left">
                                                        <h5 class="title">{{$item->title}}</h5>
